...
class App extends React.Component {
  ...
  fetchMeasurementOutline = (waterbodyId, date) => {
    axios
      .get("/static/38784/maps/${date.format('YYYY-MM-DD',)}.json",)
      .then(res => {
        this.setState({
      ...
      <div id="app">
        ...
        <div id="footer2" className='bg-body-tertiary rounded-top '>
          ...
          <div className='col-md-6'>
            <img src={"/media/cnrs_logo.png"} alt="Logo CNRS"  style={{maxWidth: '40%',maxHeight: 100,}} />
            <img src={"/media/ncrs_logo.png"} alt="Logo NCRS"  style={{maxWidth: '40%',maxHeight: 100,}}/>
          </div>
            </div>
